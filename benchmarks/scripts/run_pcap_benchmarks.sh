...
java -jar target/dsbdp-0.2.0-SNAPSHOT-standalone.jar -b 1000 -d 1 -s "pcap-json-direct" > "${PREFIX}.stats_out"
...
java -jar target/dsbdp-0.2.0-SNAPSHOT-standalone.jar -b 1000 -d 1 -s "pcap-json-inc" -m "[17]" > "${PREFIX}.stats_out"
...
java -jar target/dsbdp-0.2.0-SNAPSHOT-standalone.jar -b 1000 -d 1 -s "pcap-json-inc" -m "[8 9]" > "${PREFIX}.stats_out"
...
java -jar target/dsbdp-0.2.0-SNAPSHOT-standalone.jar -b 1000 -d 1 -s "pcap-json-inc" -m "[6 5 6]" > "${PREFIX}.stats_out"
...
java -jar target/dsbdp-0.2.0-SNAPSHOT-standalone.jar -b 1000 -d 1 -s "pcap-json-inc" -m "[6 2 3 2 4]" > "${PREFIX}.stats_out"
...
java -jar target/dsbdp-0.2.0-SNAPSHOT-standalone.jar -b 1000 -d 1 -s "pcap-json-inc" -m "[5 2 3 2 3 2]" > "${PREFIX}.stats_out"
